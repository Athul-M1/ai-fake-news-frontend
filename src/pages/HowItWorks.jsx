...
export default function HowItWorks() {
            ...
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                >
                    <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                        <div className="flex-1 w-full bg-gradient-to-br from-pink-600/20 via-pink-600/10 to-transparent border border-pink-600/30 rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 backdrop-blur-sm">
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-8">
                        <div className="flex-1 bg-gradient-to-bl from-purple-600/20 via-purple-600/10 to-transparent border border-purple-600/30 rounded-3xl p-8 backdrop-blur-sm">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <h3 className="text-2xl font-bold text-white">Simulated Analysis</h3>
                            </div>
                            <p className="text-slate-300 mb-4">The UI simulates deep-processing routines to verify authenticity markers</p>
                            <div className="space-y-2">
                                <div className="bg-black/30 rounded-xl p-3 border border-slate-700">
                                    <p className="text-sm text-purple-400 font-mono">Internal Logic → Mock Processor</p>
                                </div>
                                <div className="bg-black/30 rounded-xl p-3 border border-slate-700">
                                    <p className="text-sm text-slate-400">Simulation of Heavy Computational Work</p>
                                </div>
                            </div>
                        </div>
                        <div className="hidden md:block">
                        ...
                        <div className="bg-black/40 rounded-xl p-6 border border-pink-600/30">
                            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4">
                                <div className="text-center">
                                    <p className="text-cyan-400 font-bold text-sm sm:text-base">Rule Score</p>
                                </div>
                                <span className="text-xl sm:text-2xl text-pink-600">+</span>
                                <div className="text-center">
                                    <p className="text-violet-400 font-bold text-sm sm:text-base">ML Probability</p>
                                </div>
                                <span className="text-xl sm:text-2xl text-pink-600">=</span>
                                <div className="text-center">
                                    <p className="text-pink-400 font-bold text-sm sm:text-base">Final Score</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <div className="bg-gradient-to-br from-pink-600/20 via-pink-600/10 to-transparent border border-pink-600/30 rounded-3xl p-8 backdrop-blur-sm">
                        ...
                        <div className="bg-black/40 rounded-xl p-4 border border-slate-700 overflow-x-auto">
                            <pre className="text-xs sm:text-sm text-pink-400 font-mono overflow-x-auto">
                                {`{
  ...
  "ml_probability": 0.92
                ...
                >
                    <h3 className="text-3xl font-bold text-center mb-10 text-white">Built With</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gradient-to-br from-pink-600/10 to-transparent border border-pink-600/20 rounded-2xl p-8 w-full md:col-span-2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-black/30 rounded-lg p-3">
                                    <div className="w-2 h-2 bg-pink-600 rounded-full"></div>
                                    <span className="text-slate-300">Lucide React Icons</span>
                                </div>
                                <div className="flex items-center gap-3 bg-black/30 rounded-lg p-3">
                                    <div className="w-2 h-2 bg-pink-600 rounded-full"></div>
